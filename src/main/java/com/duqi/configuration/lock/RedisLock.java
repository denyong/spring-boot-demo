...
//    getAndSet:获取之前旧的value，并设置新的value
    System.out.println(stringRedisTemplate.opsForValue().getAndSet("key", "123"));;
    System.out.println(stringRedisTemplate.opsForValue().getAndSet("key", "123"));;
    System.out.println(stringRedisTemplate.opsForValue().getAndSet("key", "456"));;
    System.out.println(stringRedisTemplate.opsForValue().getAndSet("key", "789"));;
    Boolean aBoolean = stringRedisTemplate.opsForValue().setIfAbsent(lockKey, timeStamp);
